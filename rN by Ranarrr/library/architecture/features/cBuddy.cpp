...
void cBuddy::RegisterCmds() {
	/*rN v0.13*/ reg_cmd( "buddy_add", true, addbuddy, nullptr ) //g_Engine.pfnAddCommand( PrefHack( "", Prefix_ini(), "buddy_add" ), addbuddy );
	/*rN v0.13*/ reg_cmd( "buddy_search", true, searchbuddy, nullptr ) // g_Engine.pfnAddCommand( PrefHack( "", Prefix_ini(), "buddy_search" ), searchbuddy );
}